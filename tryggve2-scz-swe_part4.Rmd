...
summary(coxph(Surv(time_sui, suicide_yn) ~ infect.type, data=analysis))$conf.int -> row19 
...
rbind(row1,row2,row3,row4,row5,row6,row7,row8,row9,row10,row11,row12,row13,row14,row15,
      row15,row16,row17,row18,row19,row20,row21) -> cox.univ  
...
cox.multi <- summary(coxph(Surv(time_sui, suicide_yn) ~ sex + age.first.scz +
                             ...
                             infect.pre.scz + congen.malform + intdis.pre.scz + 
                             large_munc_sczdx + infect.type + EduYr.id + fhx.scz,
...
res$predictors <- factor(res$predictors, levels=rev(c("sexM",
                                                      "age.first.scz",
                                                      "bip.pre.scz",
                                                      "anx.pre.scz",
                                                      "ptsd.pre.scz",
                                                      ...
                                                      "intdis.pre.scz",
                                                      "large_munc_sczdx",
                                                      "infect.typegastrointestinal",
                                                      "infect.typegenital",
                                                      "infect.typehepatitis",
                                                      "infect.typeno infect",
                                                      "infect.typeotitis media",
                                                      "infect.typerespiratory",
                                                      "infect.typesepsis",
                                                      "infect.typeskin",
                                                      "infect.typeurological",
                                                      "EduYr.id",
                                                      "fhx.scz"
                                                  )))
...
summary(coxph(Surv(time_pd, pd_yn) ~ infect.type, data=analysis))$conf.int -> row19 
...
summary(coxph(Surv(time_hsp, hsp_yn) ~ infect.type, data=analysis))$conf.int -> row19 
...
rbind(row1,row2,row3,row4,row5,row6,row7,row8,row9,row10,row11,row12,row13,row14,row15,
      row15,row16,row17,row18,row19,row20,row21,row22) -> cox.univ  

rm(row1,row2,row3,row4,row5,row6,row7,row8,row9,row10,row11,row12,row13,row14,
   row15,row16,row17,row18,row19,row20,row21,row22)
...
cox.multi <- summary(coxph(Surv(time_hsp, hsp_yn) ~ sex + age.first.scz +
                             ...
                             asd.pre.scz + mdd.pre.scz + ai.pre.scz + cancer.pre.scz +
                             infect.pre.scz + congen.malform + intdis.pre.scz + 
                             large_munc_sczdx + infect.type + EduYr.id + fhx.scz + birthyear,
                           data=analysis))$conf.int

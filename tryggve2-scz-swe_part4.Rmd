...
summary(coxph(Surv(time_sui, suicide_yn) ~ bip.pre.scz, data=analysis))$conf.int -> row4


summary(coxph(Surv(time_sui, suicide_yn) ~ infect.pre.scz, data=analysis))$conf.int -> row3
summary(coxph(Surv(time_sui, suicide_yn) ~ sex, data=analysis))$conf.int -> row1 
summary(coxph(Surv(time_sui, suicide_yn) ~ EduYr.id, data=analysis))$conf.int -> row5
summary(coxph(Surv(time_sui, suicide_yn) ~ fhx.scz, data=analysis))$conf.int -> row6
...
rbind(row1,row2,row3,row4,row5,row6) -> cox.univ  
...
cox.multi <- summary(coxph(Surv(time_sui, suicide_yn) ~ 
                             ...
                             psych_pre.scz + EduYr.id + fhx.scz, data=analysis))$conf.int
...
labels <- c(`0` = "unadjusted (N=13806, event=1795)", `1` = "adjusted (N=13450, event=1720)")
...
ggsave(file="~/Documents/projects/5.tryggve2/tryggve2/paper1/fig_sui2_18apr19.png",fig2, width=8, height=6)
...
summary(coxph(Surv(time_pd, pd_yn) ~ EduYr.id, data=analysis))$conf.int -> row5
summary(coxph(Surv(time_pd, pd_yn) ~ fhx.scz, data=analysis))$conf.int -> row6
...
cox.multi <- summary(coxph(Surv(time_pd, pd_yn) ~ 
                             sex + age.first.scz + infect.pre.scz +
                             psych_pre.scz +
                             fhx.scz + EduYr.id, data=analysis))$conf.int
#z_edlevel 
cox.adj <- as_tibble(cox.multi) %>% 
  mutate(predictors=row.names(cox.multi), adj=1)  %>%
  rename("HR"="exp(coef)", "HR_neg"="exp(-coef)", "HR_95L"="lower .95", "HR_95H"="upper .95") %>% 
...
# put both unadjusted and adjusted estimates into facets, side by side
labels <- c(`0` = "unadjusted (N=13806)", `1` = "adjusted (N=13450, event=1121))")
...
ggsave(file="~/Documents/projects/5.tryggve2/tryggve2/paper1/fig_prematuremort_18apr19.png",fig2, width=8, height=6)
...
summary(coxph(Surv(time_hsp, hsp_yn) ~ EduYr.id, data=analysis))$conf.int -> row5
summary(coxph(Surv(time_hsp, hsp_yn) ~ fhx.scz, data=analysis))$conf.int -> row6
...
summary(coxph(Surv(time_hsp, hsp_yn) ~ birthyear, data=analysis))$conf.int -> row10

rbind(row1,row2,row3,row4,row5,row6,row10) -> cox.univ  
...
cox.multi <- summary(coxph(Surv(time_hsp, hsp_yn) ~ 
                             sex + age.first.scz + infect.pre.scz +
                             psych_pre.scz + EduYr.id +
                             birthyear + fhx.scz, data=analysis))$conf.int
#z_edlevel 
cox.adj <- as_tibble(cox.multi) %>% 
  mutate(predictors=row.names(cox.multi), adj=1)  %>%
  rename("HR"="exp(coef)", "HR_neg"="exp(-coef)", "HR_95L"="lower .95", "HR_95H"="upper .95") %>% 
...
# put both unadjusted and adjusted estimates into facets, side by side
labels <- c(`0` = "unadjusted (N=13806)", `1` = "adjusted (N=13450, event=4112)")
...
ggsave(file="~/Documents/projects/5.tryggve2/tryggve2/paper1/fig_longHSP_18apr19.png",fig2, width=8, height=6)

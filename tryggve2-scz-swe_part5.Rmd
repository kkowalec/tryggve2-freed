...
cor.test(rowSums(sub), EFA_model$scores)   # I quickly checked that the rowSums and factor scores - super correlated
...
# specific outcome
train.fit.2 <- coxph(Surv(time_trs, trs_yn) ~ sex + age.first.scz +
                             bip.pre.scz + anx.pre.scz + ptsd.pre.scz + adhd.pre.scz +
                             ed.pre.scz + sui.pre.scz + suds.pre.scz + ocd.pre.scz +

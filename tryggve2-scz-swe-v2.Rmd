...
# need birth year and sex from population reg
education <- inner_join(education,pop, by="id")

education <- education %>%
  mutate(edyrs = case_when(str_detect(edlevel,"^1") ~ "6",
...
education$edyrs <- as.numeric(education$edyrs)
education$birth.yr <- as.numeric(education$birth.yr)
education$sex <- as.numeric(education$sex)

education$z_edyrs <- rstandard(lm(education$edyrs ~ education$birth.yr + education$sex))

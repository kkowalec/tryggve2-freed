...
######## Education ##########
############################# 
# standardize by birth year and sex
...
### Step X: Outcome 1 & 2: Suicide - attempts or completed
...
### Step X: Outcome 3: Premature mortality
...
### Step X: Outcome 4: Hospitalisations for SCZ
...
```
### Step X: Outcome 5: Treatment resistance - Clozapine only
```{r}
...
### Step X: Outcome 6: Hospitalisation for somatic disease
...
```
### Step X: Outcome 7: Disability
Use below, as per C. Dalman BMJ 2016 paper on refugee risk of SCZ in Sweden:
* DISPINKPERSF/Disposable income. Individual, estimated from the total family value, 100 SEK (1990-2004)
* DISPINKPERSF04/Disposable income. Individual, estimated from the total family value, 100 SEK (2004-2008)
```{r}



```
### Step X: Outcome 8: Divorce
Use LISA register and divorce records - civil status is measured each year. one way to operationalise this is one year someone is divorce - register that as the first date?
```{r}

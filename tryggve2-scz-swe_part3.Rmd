...
### Step 1: Outcome 1: Suicide - attempts or completed
...
### Step 2: Outcome 2: Premature mortality
...
### Step 3: Outcome 3: Hospitalisations for SCZ
...
```
### Step 4: Outcome 4: Treatment resistance - Clozapine only
```{r}
...
### Step 5: Outcome 5: Hospitalisation for somatic disease
...
```
### Step 6: Outcome 6: Disability, divorce
...
table(civil$num_chg)
#    1     2     3     4     5 
#53777  7658  2208    31     1


# merge back w original data

civil <- left_join(civil, lisa)

civil <- civil %>%
  arrange(id, year) %>%
  filter(!is.na(civil.status)) %>%
  select(id,year,civil.status)

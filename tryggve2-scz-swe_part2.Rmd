...
sams_scz <- sams_scz %>%
  ...
  slice(1) %>%
  select(id,SAMSNAMN,REGFAM,GRUPP) # select needed variables
...
# re-categorize into urban vs rural
# as defined by Wimberley et al Lancet Psych 2016 study on tx resistance in SCZ

# https://en.wikipedia.org/wiki/Counties_of_Sweden

scz <- scz %>%
  mutate(local_scz_dx_dichot = case_when(local_scz_dx == "Stockholms län" | "Kalmar län" | "Örebro län" | "Uppsala län" | ""))
```

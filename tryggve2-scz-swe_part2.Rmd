...
data.f <- "/Volumes/Common/projects/S3/S3_Research/tryggve2/data/scz.part1.RData"
...
bip <- hdr %>%
  filter( ((icd.version==8) & grepl('^2961|^2963|^2968',diagnosis)) |
          ((icd.version==9) & grepl('^296|^296A|^296C|^2961|^296D|^2694|^296E|^2965|^296F|^2966|^296G|^2967|^296H|^2961|^29689|^296W|^29699|^296X',diagnosis)) | 
...
+ medication use (wait on this-not sure which drugs to focus on)
```{r hospitalisations, medical history}

...
```
12. Merge with SCZ per-indiv records & apply exclusion criteria
...
infect <- scz.hdr %>%
   filter((icd.version!=10 & grepl("^001|^002|^003|^004|^005|^006|^007|^008|^009|
                                  ^013|^02701|^03609|^035|^038|^041|^042|^043|^04509|
                                  ^04699|^050|^051|^052|^053|^054|^055|^056|^057|^06209|
                                  ^063|^064|^065|^070|^07199|^07202|^07501|^07929|^09049|^0949|
                                  ^110|^111|^32300|^381|^382|^320|^322|^392|^46|^47|^48|
                                  ^540|^580|^590|^59500|^59501|^612|^620|^622|^680|^681|^682|^683|^684|^685|^686", diagnosis))
      | (icd.version==10 & grepl("^A40|^A41|^A00|^A01|^A02|^A03|^A04|^A05|^A06|^A07|^A08|^A09|^A17|^A46|^A80|
                                  ^A548A|^A548D|^A521A|^A521B|^A229C|^A321|^A504|^A390|
                                  ^B00|^B01|^B02|^B03|^B04|^B05|^B06|^B07|^B08|^B09|^B010|^B011|^B15|^B16|^B17|^B18|^B19|
                                  ^B261|^B262|^B375|^B451|^B582|^B602|^E236A|^K35|^L00|^L01|^L02|^L03|^L04|^L05|^L06|^L07|^L08|
                                  ^N00|^N10|^N300|^N390|^N518B|^N70|^N71|^N72|^N76|^N770D|^N771B|^N771L|^H65|^H66|^H67|^I02|
                                  ^G00|^G01|^G02|^G03|^G04|^G05|^G06|^G07", diagnosis))) %>%
  mutate(infect = 1,
         admit.date = ymd(as.character(admit.date))) %>%
  arrange(id, admit.date) %>%
  group_by(id) %>%
